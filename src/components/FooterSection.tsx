...
const FooterSection = () => {
  return (
    <footer className="border-t border-primary/10 bg-card py-16 px-6">
      ...
      <div className="container mx-auto mt-12 pt-6 border-t border-primary/10 text-center text-xs text-muted-foreground">
