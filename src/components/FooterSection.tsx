    ...
    <footer id="contact" className="border-t border-border bg-card py-16 px-6">
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <a
            href="#partner-form"
            className="inline-block px-5 py-2 rounded-lg border border-accent text-accent text-sm font-semibold hover:bg-accent hover:text-accent-foreground transition-all"
          >
            Become a Partner
          </a>
        </div>
      ...
      <div className="container mx-auto mt-12 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between text-xs text-muted-foreground gap-4">
