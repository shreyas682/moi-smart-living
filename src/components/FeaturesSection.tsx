...
const FeatureCard = ({ feature, index }: { feature: typeof features[0]; index: number }) => {
  ...
  return (
    <motion.div
      ...
      className="group relative card-premium rounded-2xl p-10 text-center overflow-hidden cursor-default hover:-translate-y-2 hover:border-primary transition-all duration-300"
    >
